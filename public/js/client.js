...
socket.on("exists", function(data) {
  $("#errors").empty();
  $("#errors").show();
  $("#errors").append(data.msg + " جرب  <strong>" + data.proposedName + "</strong> ");
    toggleNameForm();
    toggleChatWindow();
});
...
socket.on("history", function(data) {
  ...
  socket.on("update-people", function(data){
    //var peopleOnline = [];
    $("#people").empty();
    $('#people').append("<li class=\"list-group-item active\">متواجديين الان <span class=\"badge\">"+data.count+"</span></li>");
    $.each(data.people, function(a, obj) {
      ...
      $('#people').append("<li class=\"list-group-item\"><span>" + obj.name + "</span> <i class=\"fa fa-"+obj.device+"\"></i> " + html + " <a href=\"#\" class=\"whisper btn btn-xs\">خاص</a></li>");
      //peopleOnline.push(obj.name);
    });
